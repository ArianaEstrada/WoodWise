...
<div class="container py-5">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#createFormulaModal">
                Agregar Fórmula
            </button>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($formulas as $formula)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#viewFormulaModal{{ $formula->id_formula }}">Ver</button>
                                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editFormulaModal{{ $formula->id_formula }}">Editar</button>
                                    <button class="btn btn-danger btn-sm" onclick="confirmDelete({{ $formula->id_formula }})">Eliminar</button>
                                </td>
                            </tr>
